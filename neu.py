...
# Eine Funktion, die die Daten des Datensatzes filtert, um nur die Einträge der 'aquatic mammals' Superklasse zu behalten.
#und die Datensätze in einem File speichert
...
# 'shuffle=False' wird hier typischerweise gesetzt, da beim Testen die Reihenfolge der Daten nicht wichtig ist.
